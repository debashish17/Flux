...
export default function DocumentEditor() {
    ...
    const [hasAutoGenerated, setHasAutoGenerated] = useState(false); // Prevent race condition

    // Auto-generate on mount if document is empty (DOCX only)
    useEffect(() => {
        if (!hasAutoGenerated && project && project.sections && project.sections.length > 0) {
    ...
    }, [project?.id, hasAutoGenerated]); // Include dependencies
        ...
        <>
            ...
            <div className="flex h-screen bg-gray-100 overflow-hidden" style={{ height: 'calc(100vh - 64px)' }}>
                ...
                <div className="flex-1 flex flex-col min-w-0 transition-all duration-300">
                    {/* Document Content */}
                    <div className="flex-1 overflow-y-auto" style={{ marginRight: chatOpen }}>
